...
$(document).on("click", '#myonoffswitch24', function () {
    if (this.checked) {
        ...
        (document.getElementById("style").setAttribute("href", "../assets/assets/plugins/bootstrap/css/bootstrap.rtl.min.css"));
        ...
        $("head link#style").attr("href", $(this));
        (document.getElementById("style").setAttribute("href", "../assets/assets/plugins/bootstrap/css/bootstrap.min.css"));
    }
});
// RTL STYLE END
